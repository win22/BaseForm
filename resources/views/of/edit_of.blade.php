                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <select  class="form-control" name="of_formation">
                                <option class="text-success" value="{{ $of_info->of_formation }}">{{ $of_info->of_formation }}</option>
                        ...
                        <div class="col-md-4">
                            <select  class="form-control" name="of_status">
                                ...
                                <option class="text-success" value="{{ $of_info->of_status }}">Activé</option>
                                @else
                                <option class="text-danger" value="{{ $of_info->of_status }}">Désactivé </option>
                                @endif
                            </select>
                            @if($errors->has('of_formation'))
                            <small class="form-text text-muted text-danger">{{$errors->first('of_formation')}}</small>
