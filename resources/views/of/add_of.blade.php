        ...
        <div class="card">
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" action="{{ url('/save-of')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="bmd-label-floating">Raison Social <span
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required value="{{ old('of_adresse') }}" name="of_adresse" type="text"
                                       class="form-control">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="bmd-label-floating">Adresse e-mail <span
                                            class="text-danger">*</span></label>
                                <input required value="{{ old('of_email') }}" name="of_email" type="email"
                                       class="form-control">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input required value="{{ old('of_phone') }}" name="of_phone" type="text"
                                       class="form-control">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <select required class="form-control dynamic2" id="of_etat" name="of_etat">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input required type="date" class="form-control text-success" min="1800-08-13" name="of_date_ad">
                            </div>
                        ...
                        <div class="col-md-4 ">
                            <select required class="form-control" name="of_formation">
