                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <p class="card-title">
                                    <span class="text-info" style="font-family: 'Manjari Bold'"> {{ strftime("%d %B %Y", strtotime($ei_info->ei_date_ad)) }}</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <p class="card-title">
                                    <span class="text-success" style="font-family: 'Manjari Bold'"> {{ strftime("%d %B %Y", strtotime( $ei_info->ei_date_debut)) }}</span>
                                </p>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <p class="card-title">
                                    <span class="text-danger" style="font-family: 'Manjari Bold'"> {{ strftime("%d %B %Y", strtotime( $ei_info->ei_date_fin))  }}</span>
                                </p>
                            </div>
                        </div>
                        @endif
