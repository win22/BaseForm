...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" action="{{ url('/update-doc',$doc_info->doc_id)}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div>
                                ...
                                <input  accept=".pdf,.doc" type="file" name="doc_file">
                            </div>
                    ...
                    <a href="/all-even" id="md." class="btn btn-danger pull-right">
